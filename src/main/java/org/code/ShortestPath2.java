                ...
                && !sourceNodeDetails[INDEX_SOURCE_NODE_STATUS].equalsIgnoreCase(MARKED))
        {
            ...
            if (value.toString().trim().length() > 0)
            {
                ...
                for (int index = 0; index < tokens.length; index++)
                {
                    ...
                    reporter.incrCounter(ShortestPath2.CUSTOM_COUNTERS, ShortestPath2.NUMBER_OF_UNMARKED_NODES_TO_BE_PROCESSED, 1);
...
public class ShortestPath2 extends Configured implements Tool
{
    ...
    public int run(String[] args) throws Exception
    {
        ...
        do
        {
            JobConf conf = new JobConf(getConf(), ShortestPath2.class);
    ...
    {
        int exitCode = ToolRunner.run(new ShortestPath2(), args);
